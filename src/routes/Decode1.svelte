...
<div class="intro-decode">
    <div class="pres-decode">
        <h1>Rio 60 graus</h1>
        <p>
            Rio bate o recorde de 60 °C de sensação térmica e os jornais abrem
            ...
            dentro de ônibus sem ar condicionado.
        </p>
    </div>
        ...
        <ul>
            <li>
                <a
                    ...
                    target="_blank"
                    >Tabela de posições de GPS de todos os validadores da Jaé
                    instalados, incluindo estado do equipamento, serviço,
                    sentido e veículo associado e temperatura do veículo.</a
                >
            </li>
            <li>
                <a
...
<div class="content-decode">
    <p>
        Às 12h35 do dia 17 de fevereiro de 2025, o Rio atingiu o Nível de Calor
    ...
    <h3>
        Quais linhas colocaram para rodar, em 17 de fevereiro de 2025, veículos
        sem ar condicionado, cuja temperatura interna ultrapassou os 50 °C?
    </h3>
    <p>
    ...
    <div class="split-cont">
        <div class="split-left">
            <p>
                Os dados de temperatura estão disponíveis em um banco de dados
                disponibilizado pela Secretaria Municipal de Transportes chamado <a
                    href="https://console.cloud.google.com/bigquery?p=rj-smtr&d=br_rj_riodejaneiro_bilhetagem&t=gps_validador&page=table"
                    target="_blank"
                    >Tabela de posições de GPS de todos os validadores da Jaé
                    instalados, incluindo estado do equipamento, serviço,
                    sentido e veículo associado e temperatura do veículo</a
                >
                (código rj-smtr.br_rj_riodejaneiro_bilhetagem.gps_validador`).<br
                />Para acessar as temperaturas de todos os ônibus municipais em
                17 de fevereiro de 2025, é necessário executar a seguinte busca:
            </p>
        </div>
...
AND temperatura > 50.0
    ...
    <p>
        Esta é a tabela das linhas que colocaram para rodar, em 17 de fevereiro
        ...
        envolvidas, para compará-lo com a extensão de toda a rede.
    </p>
        ...
        <div class="split-left">
            <p>
                ...
                <a
                    ...
                    >GTFS - Shapes em formatos geográficos para cada rota</a
                >
                . Cada dado espacial está associado a um identificador que, por várias
                ...
                (que obtenho da tabela GTFS - Formatos geográficos para cada rota).
            </p>
        </div>
        <div class="split-right">
            <p>
...
WHERE shape_id IN ("byuc", "fl98", "y35p", "O0112AAA0AIDU02", "O0864AAA0AIDU01", "O0919AAA0AVDU02", "10f900a8-7a30-43b5-a2a3-bde69060e1be", "49ff21ac-2dab-4583-81ff-337fafcab12c",..., "yhfv")
    ...
    <div class="split-cont" style="margin-top: 3rem;">
        <div class="split-left">
            <p>
                As geometrias extraídas se encontram no formato WKT “Well-known
                ...
                Um exemplo de geometria no formato WKT é:
            </p>
            <pre><code>
        ...
        <div class="split-left">
            <p>
                É possível responder a essa pergunta consultando a <a
                    ...
                    instalados, incluindo estado do equipamento, serviço,
                    sentido e veículo associado e temperatura do veículo</a
                >. Essa questão levanta diferentes assuntos, desde atrasos na
                ...
                apresenta resultados nulos ou iguais a 0.
            </p>
        </div>
        <div class="split-right">
            <p>
